          ...
          <li>
            <div class="tabla-precio">
              ...
              <div class="orden">
                ...
                <input type="hidden" value="30"  name="boletos[un_dia][precio]"> <!--este campo input se agrego al momento de implememtar paypal, el value= 30, si es tienda virtual lo tomas de BD em imprimes el valor -->
              </div>
          ...
          <li>
            <div class="tabla-precio">
              ...
              <div class="orden">
                ...
                <input type="hidden" value="50"  name="boletos[completo][precio]"><!--se agrego en paypal-->
              </div>
            </div>
          </li>
          <li>
            <div class="tabla-precio">
              ...
              <div class="orden">
                ...
                <input type="hidden" value="45"  name="boletos[2dias][precio]"><!--se agrego en paypal-->
              </div>
            </div>
          </li>
      ...
      <div id="resumen" class="resumen">
        ...
        <div class="caja clearfix">
          <div class="extras">
            ...
            <div class="orden">
              <label for="etiquetas">paquetes de 10 etiquetas $2 <small>(HTML5, CCS3,  JavaScrip, Crome)</small></label>
